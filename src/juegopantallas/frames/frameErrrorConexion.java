 ...
 * @author Soulshiryu
 */
public class frameErrrorConexion extends javax.swing.JFrame {

    /**
     * Creates new form frame_errordeconexion
     */
    public frameErrrorConexion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameErrrorConexion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frameErrrorConexion().setVisible(true);
            }
        });
    }
