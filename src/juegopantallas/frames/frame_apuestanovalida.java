 ...
 * @author Soulshiryu
 */
public class frame_apuestanovalida extends javax.swing.JFrame {

    /**
     * Creates new form frame_apuestanovalida
     */
    public frame_apuestanovalida() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frame_apuestanovalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frame_apuestanovalida().setVisible(true);
            }
        });
    }
