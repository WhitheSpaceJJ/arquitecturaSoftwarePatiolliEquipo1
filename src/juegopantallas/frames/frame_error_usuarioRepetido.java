 ...
 * @author Soulshiryu
 */
public class frame_error_usuarioRepetido extends javax.swing.JFrame {

    /**
     * Creates new form frame_error_usuarioRepetido
     */
    
    public frame_error_usuarioRepetido() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frame_error_usuarioRepetido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frame_error_usuarioRepetido().setVisible(true);
            }
        });
    }
