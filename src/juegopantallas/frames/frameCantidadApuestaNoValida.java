 ...
 * @author Soulshiryu
 */
public class frameCantidadApuestaNoValida extends javax.swing.JFrame {

    /**
     * Creates new form frame_incorrectocantidadaquitar
     */
    public frameCantidadApuestaNoValida() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameCantidadApuestaNoValida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frameCantidadApuestaNoValida().setVisible(true);
            }
        });
    }
