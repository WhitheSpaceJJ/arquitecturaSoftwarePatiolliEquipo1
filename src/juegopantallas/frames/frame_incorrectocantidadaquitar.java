 ...
 * @author Soulshiryu
 */
public class frame_incorrectocantidadaquitar extends javax.swing.JFrame {

    /**
     * Creates new form frame_incorrectocantidadaquitar
     */
    public frame_incorrectocantidadaquitar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea3.setText("cantidad a quitar incorrecta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frame_incorrectocantidadaquitar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frame_incorrectocantidadaquitar().setVisible(true);
            }
        });
    }
