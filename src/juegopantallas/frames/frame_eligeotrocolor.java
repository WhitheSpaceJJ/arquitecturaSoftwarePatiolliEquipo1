 ...
 * @author Soulshiryu
 */
public class frame_eligeotrocolor extends javax.swing.JFrame {

    /**
     * Creates new form frame_eligeotrocolor
     */
    public frame_eligeotrocolor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea3.setText("Color repetido, elige otro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frame_eligeotrocolor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frame_eligeotrocolor().setVisible(true);
            }
        });
    }
