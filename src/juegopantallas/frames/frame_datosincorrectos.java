 ...
 * @author Soulshiryu
 */
public class frame_datosincorrectos extends javax.swing.JFrame {

    /**
     * Creates new form frame_datosincorrectos
     */
    public frame_datosincorrectos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea3.setText("Datos de usuario incorrectos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frame_datosincorrectos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frame_datosincorrectos().setVisible(true);
            }
        });
    }
