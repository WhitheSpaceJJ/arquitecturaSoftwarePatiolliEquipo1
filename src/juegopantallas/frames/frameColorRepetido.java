 ...
 * @author Soulshiryu
 */
public class frameColorRepetido extends javax.swing.JFrame {

    /**
     * Creates new form frame_eligeotrocolor
     */
    public frameColorRepetido() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameColorRepetido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frameColorRepetido().setVisible(true);
            }
        });
    }
